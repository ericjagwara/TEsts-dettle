    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xs text-gray-500 mt-2 leading-relaxed">
          This platform helps schools monitor hand-washing facilities, distribute learning materials, and measure the impact of hygiene education across Uganda.
        </p>
      </div>
          ...
          <form onSubmit={step === "initial" ? handleSendOTP : handleVerifyOTP}>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <Input 
                      id="phone" 
                      type="tel" 
                      placeholder="Enter your phone number (e.g., 0772207616)" 
                      value={phone} 
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              >
                {isLoading 
                  ? (step === "initial" 
                      ? (isLogin ? "Sending OTP..." : "Sending OTP...") 
